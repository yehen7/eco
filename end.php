      ...
      <div class="bg-white rounded-lg shadow-sm p-5">
        ...
        <div class="tab-content">
          ...
          <div id="nav-tab-card" class="tab-pane fade show active">
            ...
            <form role="form" action="end.php" method="POST">
            <?php
          ...
          <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <br>
                    <input type="radio" id="payment" name="payment" value="MasterCard">
  <label for="payment">MasterCard</label></label><br>
  <input type="radio" id="payment" name="payment" value="Visa">
  <label for="payment">Visa</label></label><br>
                 </div>
              <div class="form-group">
...
if(isset($_POST['submit'])){
   ...
   $sql = "INSERT INTO orders (id,name,email,address,total,payment,card,expireM,expireY,cvv)
   VALUES
   ('$id','$name','$email','$address','$total', '$payment','$cardnumber','$expireM','$expireY','$cvv')";
